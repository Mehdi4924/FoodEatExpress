              ...
              height:'100%',
                      ...
                      <View
                        ...
                        <View
                          ...
                          <Text
                            ...
                            {country!=null?country=="pakistan"?'PKR':'£':'£'}{this.state.subtotal}
                          </Text>
                        </View>
                      </View>
                      <View
                        ...
                        <View
                          ...
                          <Text
                           ...
                           {country!=null?country=='pakistan'?'PKR':'£':'£'}{this.state.texs}
                          </Text>
                        </View>
                      </View>
                      <View
                ...
                /> */}
                          <Text
                            ...
                            {country!=null?country=='pakistan'?'PKR':'£':'£'}{this.state.deliveryCharges}
                          </Text>
                        </View>
                      </View>
                      <View
                      ...
                      <View
                        ...
                        <View
                          ...
                          <Text
                            ...
                            {country!=null?country=='pakistan'?'PKR':'£':'£'}{this.state.total}
                          </Text>
                        </View>
                      </View>
                    </View>
                            ...
                            <View>
                              <View
                                ...
                                <View style={{ marginHorizontal: responsiveHeight(2) }}>
                                    ...
                                    itmm.menu.map(itm => {
                                      return (
                                        <Text style={{ color: 'rgba(0,0,0,0.3)' }}>
                                          <Text>
                                            {itm.quantity} lllllx {itm.size} {itmm.item.name}{' '}
                                          </Text>
                                  ,{itmm.extra_name}
                                        </Text>
                                      );
                                  ...
                                  <Text>{country!=null?country=='pakistan'?'PKR':'£':'£'} {itmm.total}</Text>
                                </View>
                              </View>
                            </View>
                          )
                        ...
                        <View>
                          ...
                          <View
                            ...
                            <View style={{ marginHorizontal: responsiveHeight(2) }}>
                              ...
                              <Text>{country!=null?country=='pakistan'?'PKR':'£':'£'} {Array.isArray(item) ? item[index].total : item.total}</Text>
                            </View>
                          </View>
                        </View>
                      )
