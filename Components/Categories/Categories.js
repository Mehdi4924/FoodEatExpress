...
// import {selectedTextTrack} from 'react-native-video';
import {value} from '../../../country';
...
export default class Categories extends Component {
  ...
  onFocusFunction = async () => {
    console.log(
      ...
      this.props.navigation.state.params.id.country,
    );
    ...
    formdata.append(
      'branch_id',
      this.state.item == JSON.parse(id) ? this.state.item : id,
    );
    var requestOptions = {
      method: 'POST',
      body: formdata,
    ...
    fetch(`${myurl}/api/get-categories`, requestOptions)
  ...
  printCards = (post) => {
    ...
    const {params} = this.props.navigation.state;
    let item = post.item;
    // console.log('check the country state',this.props.navigation.state)
  ...
  SearchFilterFunction = async (text) => {
    ...
    var formdata = new FormData();
    formdata.append('branch_id', this.state.item ? this.state.item : id);
    formdata.append('category', text);
    console.log('this is form data', formdata);
    console.log('this is headers data', myHeaders);
    ...
    fetch(`${myurl}api/search-categories`, requestOptions)
      .then((response) => response.text())
      .then((response) => {
      ...
      .catch((error) => {
        this.setState({loading: false});
        alert('Error:Please connect to internet.', error);
        console.log('error log for search text', error);
      });
  };
