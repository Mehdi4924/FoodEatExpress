...
export default class CategoryDetail extends Component {
  ...
  checking = async () => {
    ...
    //   }
    // })
    alert(JSON.stringify(this.state.myextras))
    //alert(JSON.stringify(this.state.extras.filter[index][item.name + '_flag']))
  }
  ...
  navi = async () => {
    ...
    let tempextraid = [];
    if(this.state.myextras!=[]){
      //alert(JSON.stringify(this.state.myextras))
      this.state.myextras.map((value)=>{
        tempextraid.push(value.id)
      })
    }
    //alert(JSON.stringify(tempextraid))
    let item = {
      item: this.state.item,
      menu: data,
      total: this.state.total,
      //extras: this.state.myextras
      extra_id: tempextraid,
                    ...
                    <View>
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          ...
                          let check = this.state.myextras.includes(itm);
                          let checkindex = this.state.myextras.indexOf(itm);
                          //alert(JSON.stringify(check) + JSON.stringify(checkindex))

                          if (check == true) {
                            let temparray = this.state.myextras.filter((value) => value != itm)
                            this.setState({
                              myextras: temparray
                            })
                          } else {
                            this.setState({
                              myextras: this.state.myextras.concat(itm)
                            })
                          }
