...
class Checkout extends Component {
  ...
  mysave = async () => {
    ...
    if (this.state.walletcheck == true) {
      ...
      formdata.append('phone', '78128715271');
    }
    else {
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  <View
                    ...
                    <Text style={{ fontSize: responsiveFontSize(2) }}>Cash on delivery</Text>
                  </View>
                  <View
                    style={{ flex: 1 }}
                  >
                  ...
                  <TouchableOpacity
                    ...
                    onPress={async () => {
                      ...
                      if (this.state.phonenumber.length < 10) {
                        Toast.show('Please enter the phone number again!', Toast.SHORT)
                      } else {
              ...
              <TouchableOpacity
                ...
                <TouchableOpacity
                  ...
                  <View
                    ...
                    <Text style={{ fontSize: responsiveFontSize(2) }}>Pay in cash</Text>
                  </View>
                  <View
                    style={{ flex: 1 }}
                  >
