...
class Payment extends Component {
    ...
    async addcardtoserver() {
        if (this.state.cardnumber == 0 || this.state.expirymonth == 0 || this.state.expiryyear == 0 || this.state.cvc == 0) {
            ...
            Toast.show('Please input coreect expiry month and year',Toast.LONG)
        }
        else {
            ...
            //"https://pizzakebab.ranglerztech.website/api/add-card"
            fetch(`${myurl}/api/add-card`, requestOptions)
            ...
            /*setTimeout(() => {
                Toast.show('COnfirmed', Toast.SHORT);
                this.setState({ loadingbutton: false })
            }, 3000)*/
        ...
        if (this.state.anotherscreen == true) {
            ...
            return (
                <SafeAreaView forceInset={{ top: 'never' }} style={styles.maincontainer}>
                    {console.log('Hrllo from',this.state.from)}
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() => {
                                        ...
                                        if(this.state.from == 'checkout'){
                                            ...
                                            console.log('If of checkout');
                                            this.props.navigation.goBack();
                                        }else{
                                            console.log('else of checkout');
                                        } 
                                    }}
                                >
