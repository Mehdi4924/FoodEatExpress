      ...
      async () => {
        ...
        fetch(`${myurl}/api/user-data`, requestOptions)
          ...
          .then((result) => {
            ...
            if (
              dataa.successData.address &&
              dataa.successData.address.indexOf('Pakistan') > -1
            ) {
              ...
              <View style={styles.profileMainContainer}>
                ...
                {/* <TouchableOpacity
                  ...
                  <View style={styles.walletContainer}>
                    <Text style={styles.walletTextStyle1}>
                      {this.state.country && this.state.country == 'pakistan'
                        ? 'PKR'
                        : '£'}{' '}
                      {this.state.data.wallet / 100}
                    </Text>
                  </View>
                </TouchableOpacity> */}
              </View>
