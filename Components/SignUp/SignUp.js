...
export default class SignUp extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      errormodalmessage: '',
      nottoken: this.props.navigation.state.params.notificationtoken,
      timezone:''
    };
  }
        ...
        <CustomModal isVisible={this.state.errormodalvisible}>
          <View
            ...
            <View style={styles.modalMainContainer}>
              ...
              <TouchableOpacity
                style={{ backgroundColor: blue,alignSelf:'center', height: '15%', width: '60%',marginTop:10, borderRadius: 30, justifyContent: 'center', alignItems: 'center' }}
                onPress={() => {
